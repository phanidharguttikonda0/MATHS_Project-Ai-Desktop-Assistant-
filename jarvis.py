...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak(assname)
            print("My friends call me",' phani assistant')
            ...
            speak("I have been created by phani.")
            ...
            speak("Thanks to phani. further It's a secret")
            ...
            speak("I am your virtual assistant created by phani")

        elif 'reason for you' in query:
            speak("I was created as a Minor project by Mister phani ")
